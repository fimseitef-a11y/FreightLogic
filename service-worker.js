// Freight Logic Service Worker v10.2.1 — Enterprise Hardened — Enterprise Hardened
// NOTE: Security posture preserved (no "cache every GET" regression).

const CACHE_NAME = 'freight-logic-v10.2.1';
const RUNTIME_CACHE = 'freight-logic-runtime-v10.2.1';
