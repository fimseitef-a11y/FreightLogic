#!/usr/bin/env node
/**
 * FreightLogic v14.3.2-hardened — Zero-Trust Adversarial Certification
 *
 * Purpose:
...
T(app.includes("const APP_VERSION = '14.3.2-hardened'"), 'APP_VERSION is 14.3.2-hardened');
...
T(sw.includes("const SW_VERSION = '14.3.2-hardened'"), 'SW_VERSION matches 14.3.2-hardened');
...
// ------------------------------------------------------------------
console.log(`\n${'═'.repeat(70)}`);
console.log(`  FreightLogic v14.3.1 — Zero-Trust Certification (static)`);
